        ...
        <div id="mypage">
            ...
            <form id="myPageForm" onSubmit={handleSubmit}>
                <table>
                    ...
                    <tr>
                        <th>키</th>
                        <td><input type="number" name="user_height" className="round-input" onChange={(e) => setUser({...user, user_height: e.target.value})} value={user.user_height}></input></td>
                    </tr>
                    <tr>
                        <th>몸무게</th>
                        <td><input type="number" name="user_weight" className="round-input" onChange={(e) => setUser({...user, user_weight: e.target.value})} value={user.user_weight}></input></td>
                    </tr>
                    <tr>
                        <th>가입일시</th>
